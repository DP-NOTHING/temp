...
export default function ProfileScreen({ navigation }) {
  ...
  useEffect(() => {
    axios
      .post("https://road-share-backend-dp-nothing.vercel.app/api/getTransaction", {
  ...
  useEffect(() => {
    axios
      .post("https://road-share-backend-dp-nothing.vercel.app/api/getBalance", {
        email: currentUser.email,
      })
      .then((res) => {
    ...
    <>
     <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
      <View style={styles.mainContainer}>
        ...
        <Text style={styles.balance}> {balance ? balance : 0} rs</Text>
